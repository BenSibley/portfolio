...
if ( comments_open() ) { ?>
    ...
    <section id="comments" class="comments">
        <div class="comments-number">
            <h3>
                <?php comments_number( __( 'Be First to Comment', 'compete_themes_replace_me' ), __( 'One Comment', 'compete_themes_replace_me'), __( '% Comments', 'compete_themes_replace_me' ) ); ?>
            </h3>
        </div>
...
<?php comments_number( __( 'Be First to Comment', 'compete_themes_replace_me' ), __( 'One Comment', 'compete_themes_replace_me'), __( '% Comments', 'compete_themes_replace_me' ) ); ?>
            ...
            <p class="comments-closed pings-open">
                    <?php printf( __( 'Comments are closed, but <a href="%s" title="Trackback URL for this post">trackbacks</a> and pingbacks are open.', 'compete_themes_replace_me' ), esc_url( get_trackback_url() ) ); ?>
...
<?php comments_number( __( 'Be First to Comment', 'compete_themes_replace_me' ), __( 'One Comment', 'compete_themes_replace_me'), __( '% Comments', 'compete_themes_replace_me' ) ); ?>
            ...
            <p class="comments-closed">
                <?php _e( 'Comments are closed.', 'compete_themes_replace_me' ); ?>
            </p><!-- .comments-closed -->
<?php 
} else { ?>
